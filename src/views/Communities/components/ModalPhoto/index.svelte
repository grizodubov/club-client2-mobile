...
>
    ...
    ></button>
    <div
        class="absolute ease-out transition-all duration-300 w-[316px] h-[316px] left-[calc(50%-150px)] top-[calc(50%-178px)] bg-base-100 border-[4px] border-base-100 rounded-2xl overflow-hidden"
        class:opacity-0="{!open}"
