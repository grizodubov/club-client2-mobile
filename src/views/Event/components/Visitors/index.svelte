                ...
                >
                    <div class="flex justify-between items-stretch w-full">
                        ...
                        <div class="ml-4 shrink-1 grow-1 w-full flex flex-col justify-between">
                            ...
                            <div class="mt-1 h-[14px]">
                                {#if connectionsCache[user.id.toString()]}
                                    <div class="text-xs opacity-50 leading-[14px] whitespace-nowrap w-full overflow-hidden">Инициатор: {connectionsCache[user.id.toString()].creator}</div>
                                {/if}
                            </div>
                        </div>
                    </div>
