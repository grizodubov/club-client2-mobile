        ...
        {#each poll.answers as answer, i}
            ...
            >
                ...
                <div class="relative w-full h-full flex justify-between items-center">
                    ...
                    {#if selected === i}
                        <div class="rounded-full border-2 border-secondary bg-secondary w-7 h-7 flex items-center justify-center text-base-100">
                    ...
                    {:else}
                        <div class="rounded-full border-2 border-secondary w-7 h-7"></div>
                    {/if}
                </div>
            </button>
        {/each}
