        ...
        <div class="absolute left-[0px] right-[0px] top-[0px] bottom-[0px] m-[auto] w-[310px] h-[450px]">
            ...
            >
                ...
                >
                    ...
                    {/if}
                    <div class="absolute bottom-[-48px] left-[48px] h-[28px] w-[28px] bg-error rounded-[14px] flex items-center justify-around px-1.5">
                    ...
                    <div
                        class="absolute bottom-[-48px] right-[48px] h-[28px] bg-success rounded-[14px] flex items-center justify-around px-1.5"
