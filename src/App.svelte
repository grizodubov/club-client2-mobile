...
{#if currentUser.id && cardsShow}
    <div
        class="absolute top-0 left-0 w-full h-full transition-opacity duration-500 z-20 overflow-hidden"
    ...
    >
        ...
        <div class="absolute left-[0px] right-[0px] top-[-10px] bottom-[0px] m-[auto] w-[310px] h-[560px]">
            {#each cards as card (card.connection.id)}
                <div 
                    class="absolute left-[0px] top-[0px] w-[310px] h-[560px] transition-all duration-500"
