...
<div class="bg-scene flex flex-col w-full h-full min-w-[320px]">
    ...
    {#if !showKeyboard}
        <div class="shrink-0 grow-0 flex justify-around px-4 py-6">
            ...
            <MenuButton path="/partners" binding="{'ИИ'}">
                <svg class="w-6 h-6" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 32 32"><path d="M19 13h7v2h-7z" fill="currentColor"></path><path d="M19 8h11v2H19z" fill="currentColor"></path><path d="M19 3h11v2H19z" fill="currentColor"></path><path d="M11 30H7a2.006 2.006 0 0 1-2-2v-7a2.006 2.006 0 0 1-2-2v-6a2.946 2.946 0 0 1 3-3h6a2.946 2.946 0 0 1 3 3v6a2.006 2.006 0 0 1-2 2v7a2.006 2.006 0 0 1-2 2zM6 12a.945.945 0 0 0-1 1v6h2v9h4v-9h2v-6a.945.945 0 0 0-1-1z" fill="currentColor"></path><path d="M9 9a4 4 0 1 1 4-4a4.012 4.012 0 0 1-4 4zm0-6a2 2 0 1 0 2 2a2.006 2.006 0 0 0-2-2z" fill="currentColor"></path></svg>
            </MenuButton>
